 ...
 *
 * @see [no-unreadable-array-destructuring](https://github.com/sindresorhus/eslint-plugin-unicorn/blob/v38.0.1/docs/rules/no-unreadable-array-destructuring.md)
 */
