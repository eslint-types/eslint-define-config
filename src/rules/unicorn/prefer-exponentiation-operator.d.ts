 ...
 * @deprecated
 *
 * @see [prefer-exponentiation-operator](https://github.com/sindresorhus/eslint-plugin-unicorn/blob/v44.0.0/docs/deprecated-rules.md#prefer-exponentiation-operator)
 */
