 ...
 * @deprecated
 *
 * @see [prefer-exponentiation-operator](https://github.com/sindresorhus/eslint-plugin-unicorn/blob/v37.0.1/docs/deprecated-rules.md#prefer-exponentiation-operator)
 */
