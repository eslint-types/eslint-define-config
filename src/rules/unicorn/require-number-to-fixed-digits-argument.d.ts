 ...
 *
 * @see [require-number-to-fixed-digits-argument](https://github.com/sindresorhus/eslint-plugin-unicorn/blob/v39.0.0/docs/rules/require-number-to-fixed-digits-argument.md)
 */
