 ...
 *
 * @see [require-number-to-fixed-digits-argument](https://github.com/sindresorhus/eslint-plugin-unicorn/blob/v38.0.1/docs/rules/require-number-to-fixed-digits-argument.md)
 */
