 ...
 *
 * @see [require-number-to-fixed-digits-argument](https://github.com/sindresorhus/eslint-plugin-unicorn/blob/v48.0.0/docs/rules/require-number-to-fixed-digits-argument.md)
 */
