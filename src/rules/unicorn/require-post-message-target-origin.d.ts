 ...
 *
 * @see [require-post-message-target-origin](https://github.com/sindresorhus/eslint-plugin-unicorn/blob/v47.0.0/docs/rules/require-post-message-target-origin.md)
 */
