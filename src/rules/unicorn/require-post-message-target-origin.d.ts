 ...
 *
 * @see [require-post-message-target-origin](https://github.com/sindresorhus/eslint-plugin-unicorn/blob/v38.0.1/docs/rules/require-post-message-target-origin.md)
 */
