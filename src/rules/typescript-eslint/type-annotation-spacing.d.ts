 ...
 *
 * @see [type-annotation-spacing](https://github.com/typescript-eslint/typescript-eslint/blob/v4.31.2/packages/eslint-plugin/docs/rules/type-annotation-spacing.md)
 */
