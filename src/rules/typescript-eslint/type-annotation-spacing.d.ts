 ...
 *
 * @see [type-annotation-spacing](https://github.com/typescript-eslint/typescript-eslint/blob/v5.3.0/packages/eslint-plugin/docs/rules/type-annotation-spacing.md)
 */
