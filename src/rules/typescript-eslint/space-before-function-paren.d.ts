 ...
 *
 * @see [space-before-function-paren](https://github.com/typescript-eslint/typescript-eslint/blob/v5.0.0/packages/eslint-plugin/docs/rules/space-before-function-paren.md)
 */
