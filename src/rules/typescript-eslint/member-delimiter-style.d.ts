 ...
 *
 * @see [member-delimiter-style](https://github.com/typescript-eslint/typescript-eslint/blob/v5.0.0/packages/eslint-plugin/docs/rules/member-delimiter-style.md)
 */
