 ...
 *
 * @see [sort-type-union-intersection-members](https://github.com/typescript-eslint/typescript-eslint/blob/v5.3.0/packages/eslint-plugin/docs/rules/sort-type-union-intersection-members.md)
 */
