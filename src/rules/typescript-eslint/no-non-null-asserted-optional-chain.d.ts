 ...
 *
 * @see [no-non-null-asserted-optional-chain](https://github.com/typescript-eslint/typescript-eslint/blob/v5.3.0/packages/eslint-plugin/docs/rules/no-non-null-asserted-optional-chain.md)
 */
