 ...
 *
 * @see [promise-function-async](https://github.com/typescript-eslint/typescript-eslint/blob/v5.8.1/packages/eslint-plugin/docs/rules/promise-function-async.md)
 */
